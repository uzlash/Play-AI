...
export default class GameScene extends Scene {
  ...
  checkInvesment(business) {
    ...
    business.invest()
    this.sfxInvest.play()
    this.coins.explode(constants.BUSINESSES[business.key].coinsEmit, business.x + 90, business.y + 60)
  }
  ...
  checkHire(business) {
    ...
    this.coins.explode(constants.BUSINESSES[business.key].coinsEmit * 10, business.x + 90, business.y + 60)
  }
